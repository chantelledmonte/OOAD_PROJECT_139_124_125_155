<nav class="navbar navbar-expand-lg navbar-light custom-bg">
  <a class="navbar-brand" href="/home">
    <img src="resources/images/logo.jpg" width="35" height="35" class="d-inline-block align-top" alt="">
   <i><b><span class="text-color">Clinic and Pharmacy Management System</span></b></i>
  </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              CPMS was introduced to solve the complications coming from managing all the paper works
               of every patient associated with the various departments of hospitalization with confidentiality.
                CPMS provides the ability to manage all the paperwork in one place, reducing the work of staff in arranging
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 9876543201 <br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">cpms@gmail.com
            </b>
        </p>
        </div>
      </div>
